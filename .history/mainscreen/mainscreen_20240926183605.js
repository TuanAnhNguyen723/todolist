...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Hiển thị modal edit khi nhấp vào icon bút
  editButtons.forEach((button) => {
    button.addEventListener("click", (event) => {
      ...
      const taskTimeStart = button.getAttribute("data-task-time-start");
      const taskTimeEnd = button.getAttribute("data-task-time-end");
      ...
      document.querySelector("input[name='edit_time_start']").value = taskTimeStart.split(' ')[0]; // Lấy phần ngày
      document.querySelector("input[name='edit_time_end']").value = taskTimeEnd.split(' ')[0];
  ...
  // Ẩn modal edit khi bấm nút close hoặc cancel
