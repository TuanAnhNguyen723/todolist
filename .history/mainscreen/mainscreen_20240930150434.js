document.addEventListener("DOMContentLoaded", () => {
  ...
  // Sử dụng event delegation để tránh việc đăng ký sự kiện nhiều lần
  editButtons.forEach((editIcon) => {
    // Xóa sự kiện cũ nếu có trước khi gán lại
    editIcon.removeEventListener("click", handleEditButtonClick);
    editIcon.addEventListener("click", handleEditButtonClick);
  });
