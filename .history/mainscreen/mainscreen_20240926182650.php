          ...
          <div class="task-container">
            <?php foreach ($tasks_by_date as $date => $tasks): ?>
              ...
              <div class="mb-4 border-t pt-4">
                  ...
                  <!-- Hiển thị danh sách các nhiệm vụ thuộc ngày đó -->
                  <?php foreach ($tasks as $task): ?>
                      <div class="flex justify-between items-center space-x-4 my-2">
                          ...
                          <div class="flex space-x-2">
                              <button class="text-blue-500 hover:text-blue-700 fa-eye"></button>
                              <button
                                  class="text-gray-500 hover:text-gray-700 fa-pencil"
                                  ...
                                  data-task-time-start="<?php echo $task['time_start']; ?>"
                                  data-task-time-end="<?php echo $task['time_end']; ?>"
                              >
                                  <i class="fa fa-pencil"></i>
                              </button>
                              <button class="text-red-500 hover:text-red-700 fa-trash"></button>
                          </div>
                      </div>
                  <?php endforeach; ?>
              </div>
          ...
          <div class="flex items-center justify-center min-h-screen bg-black bg-opacity-50">
            <div class="relative bg-white w-96 p-6 rounded-lg shadow-lg">
              ...
              <form action="mainscreenController.php" method="POST">
                ...
                <!-- Buttons -->
                <div class="flex justify-between">
                  <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg w-full mr-2">
                    保存
                  </button>
