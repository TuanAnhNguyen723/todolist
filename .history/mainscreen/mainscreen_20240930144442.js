document.addEventListener("DOMContentLoaded", () => {
  ...
  // Không cần đổi định dạng khi gán vào input type="date"
  function showTaskEditModal(taskId) {
    // Hiển thị spinner trước khi bắt đầu tải dữ liệu
    document.getElementById("loadingSpinner").classList.remove("hidden");
  
    // Ẩn các trường input cho đến khi dữ liệu được tải
    ...
    fetch(`mainscreenController.php?task_id=${taskId}`)
      ...
      .then((task) => {
        ...
        // Ẩn spinner sau khi dữ liệu được tải xong
