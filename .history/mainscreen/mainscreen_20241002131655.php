              ...
              <div class="flex justify-between items-center space-x-4 my-2">
                ...
                <div class="flex space-x-2">
                  ...
                  <form action="./mainscreenController.php" method="POST" style="display:inline;">
                    <input type="hidden" name="task_id" data-task-id="<?php echo $task['task_id']; ?>"  value="<?php echo $task['task_id']; ?>">
                    <button type="submit" name="delete_task" class="text-red-500 hover:text-red-700">
                      <i class="fa fa-trash"></i>
                    </button>
                  </form>

                  <!-- Nút ngôi sao với điều kiện -->
                  <button class="text-gray-500 hover:text-yellow-300 star-icon <?php echo $task['star'] ? 'text-yellow-300' : ''; ?>">
