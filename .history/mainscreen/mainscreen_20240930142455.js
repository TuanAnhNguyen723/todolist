document.addEventListener("DOMContentLoaded", () => {
  ...
  function showTaskEditModal(taskId) {
    ...
    fetch(`mainscreenController.php?task_id=${taskId}`)
      ...
      .then((task) => {
        ...
        // Kiểm tra và định dạng ngày cho time_start và time_end
  ...
  // Hàm định dạng ngày từ "yyyy-MM-dd HH:mm:ss" thành "yyyy-MM-dd"
  function formatDate(dateTimeString) {
    if (dateTimeString) {
      return dateTimeString.split(" ")[0]; // Lấy phần ngày "yyyy-MM-dd" từ "yyyy-MM-dd HH:mm:ss"
    }
