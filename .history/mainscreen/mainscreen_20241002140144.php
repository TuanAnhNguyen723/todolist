        ...
        <?php foreach ($tasks as $task): ?>
            <div class="task-container2 flex justify-between items-center space-x-4 my-2">
                <div class="flex items-center space-x-4">
                    ...
                    <input
                        type="checkbox"
                        class="form-checkbox h-5 w-5 toggle-complete <?php echo $task['star'] ? 'bg-yellow-500 border-yellow-500' : ''; ?>"
                        data-task-id="<?php echo $task['task_id']; ?>"
                        <?php echo $task['checked'] ? 'checked' : ''; ?> <!-- Giữ nguyên trạng thái checked -->
                    />
