...
<html lang="ja">
  ...
  width: 100%;
  height: 100%;
  background-color: white;  /* Màu của dấu tích */
  -webkit-mask-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="white"><path fill-rule="evenodd" d="M16.707 5.707a1 1 0 01-1.414 0L9 0.707 4.707 5a1 1 0 01-1.414-1.414l5-5a1 1 0 011.414 0l7 7a1 1 0 010 1.414z" clip-rule="evenodd"/></svg>');
  -webkit-mask-size: contain;
  -webkit-mask-repeat: no-repeat;
  mask-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="white"><path fill-rule="evenodd" d="M16.707 5.707a1 1 0 01-1.414 0L9 0.707 4.707 5a1 1 0 01-1.414-1.414l5-5a1 1 0 011.414 0l7 7a1 1 0 010 1.414z" clip-rule="evenodd"/></svg>');
  mask-size: contain;
