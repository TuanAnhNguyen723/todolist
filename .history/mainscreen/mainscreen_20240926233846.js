document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll(".fa-pencil").forEach((editIcon) => {
    editIcon.addEventListener("click", function (event) {
      ...
      // Lấy thông tin từ các thuộc tính của task (sử dụng closest để lấy phần tử cha)
      const taskElement = this.closest(".task-container");

      if (taskElement) {
        // Kiểm tra nếu taskElement không phải null
        ...
        const taskDescription = taskElement.querySelector(
          ...
          ? taskElement.querySelector("input[name='description']").value
          : ""; // Kiểm tra nếu phần tử tồn tại

        const taskTimeStart = taskElement.querySelector(
          "input[name='time_start']"
        )
          ? taskElement.querySelector("input[name='time_start']").value
          : ""; // Kiểm tra nếu phần tử tồn tại

        const taskTimeEnd = taskElement.querySelector("input[name='time_end']")
          ? taskElement.querySelector("input[name='time_end']").value
          : ""; // Kiểm tra nếu phần tử tồn tại
