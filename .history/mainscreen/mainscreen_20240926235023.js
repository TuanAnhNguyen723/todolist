document.addEventListener("DOMContentLoaded", () => {
  ...
  function showTaskEditModal(task) {
    const { taskId, taskTitle, taskDescription, taskTimeStart, taskTimeEnd } = task;
    document.querySelector("input[name='edit_task_id']").value = taskId;
    document.querySelector("input[name='edit_title']").value = taskTitle;
    document.querySelector("textarea[name='edit_description']").value = taskDescription;
    document.querySelector("input[name='edit_time_start']").value = taskTimeStart;
    document.querySelector("input[name='edit_time_end']").value = taskTimeEnd;
  ...
  document.querySelectorAll(".fa-pencil").forEach((editIcon) => {
    editIcon.addEventListener("click", (event) => {
      event.preventDefault();
      const task = {
        taskId: editIcon.closest(".task-container").querySelector("input[name='task_id']").value,
        taskTitle: editIcon.closest(".task-container").querySelector(".task-text").innerText,
        taskDescription: editIcon.closest(".task-container").querySelector("input[name='description']")
          ? editIcon.closest(".task-container").querySelector("input[name='description']").value
          : "",
        taskTimeStart: editIcon.closest(".task-container").querySelector("input[name='time_start']")
          ? editIcon.closest(".task-container").querySelector("input[name='time_start']").value
          : "",
        taskTimeEnd: editIcon.closest(".task-container").querySelector("input[name='time_end']")
          ? editIcon.closest(".task-container").querySelector("input[name='time_end']").value
          : "",
      };
  ...
  document.querySelector(".fa-sliders-h").addEventListener("click", showFilterModal);
  document.getElementById("applyButton").addEventListener("click", hideFilterModal);
  document.getElementById("resetButton").addEventListener("click", hideFilterModal);
