  ...
  <body class="bg-gray-50">
    ...
    <main class="container mx-auto mt-8">
      <div class="flex justify-between">
        ...
        <div class="flex justify-between border-t-black border-t pt-4 ">
          <!-- Task List -->
          <div class="w-2/3">
            <!-- Task Groups by Date -->
            <div class="task-container">
              <?php foreach ($tasks_by_date as $date => $tasks): ?>
                <div class="mb-4 border-b-1 pt-4">
              ...
              <div id="task-summary" class="w-1/3 bg-grey-900 p-6 rounded-lg shadow-lg ml-4 bg-slate-200">
